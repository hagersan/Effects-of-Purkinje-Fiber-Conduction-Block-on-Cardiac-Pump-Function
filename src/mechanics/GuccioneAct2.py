# Guccione2 et al. 1993: Simple time varying elastance type  contraction model
...
class GuccioneAct(object):
    ...
    def PK2Stress(self):
        ...
        Tmax_vol = self.parameters["material params"]["Tmax"]

        # # Strict either/or: base cells -> 0.0, else -> Tmax
        # m = self.parameters.get("base_mask", None)  # DG0 0/1 Function
        # Tmax = conditional(gt(m, 0.5), 0.0, Tmax_vol) if m is not None else Tmax_vol
    ...
    def ls_l0(self):
        ...
        ls_l0 = conditional(le(ls, l0 + 0.002), 0.002, ls - l0)
